...
<title>Driveaway Vehicles Web Rental System</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-9">
          <div class="banner_content">
            <h1>Find Your Perfect Vehical</h1>
            <p>Driveaway:Your Ultimate Destination for Quality Vehicles </p>
            <a href="https://i.ibb.co/j5qJpZg/IMG-20230412-204135.jpg" class="btn">Read More <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Brand Vehicals</a></li>
        </ul>
      </div>
