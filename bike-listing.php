...
<body><div><div class="btn" style="margin-bottom:-20x;"><a href="/bikerental/index.php" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Back to Dashboard</a></div>
<div><h1 style="margin-left:750px;">Vehicles List</h1></div></div>
